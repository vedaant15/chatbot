...
knowledge_base, conversation_flow = {"intents": []}, {}
...
try:
    ...
    with open(FLOW_FILE, encoding='utf-8') as file:
        conversation_flow = json.load(file)
...
def get_faq_response(user_input, session_id):
    # This function remains as our fallback for free-text questions
    if not ml_model_loaded:
        return "I'm sorry, the chatbot model is not loaded."
...
def get_response_route():
    ...
    if next_node_key:
        ...
        elif next_node_key == 'final_faculty_answer': # THIS IS THE NEW LOGIC
            course_name = user_input.upper()
